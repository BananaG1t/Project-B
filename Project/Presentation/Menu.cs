static class Menu
{
    ...
    public static void DisplaySchedule()
    {
        ...
        {
            Console.WriteLine($"Location: {schedule.Location.Name}, Movie: {schedule.Movie.Name}, Room: {schedule.Auditorium.Room}, Starting time: {schedule.StartTime.ToString("dd-MM-yyyy HH:mm")}");
        }
        Console.WriteLine();
    }
}