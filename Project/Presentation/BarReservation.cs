...
{
    public static void GetBarReservation(AccountModel Account, ScheduleModel schedule, int SeatAmount)
    {
        ...
        if (BarReservationLogic.ReserveBarSeats(Account, schedule, SeatAmount))
        {
            Console.Clear();
