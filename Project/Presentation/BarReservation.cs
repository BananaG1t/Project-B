...
{
    public static void GetBarReservation(AccountModel Account, ScheduleModel schedule, int SeatAmount, ReservationModel reservation)
    {
        ...
        if (BarReservationLogic.ReserveBarSeats(Account, schedule, SeatAmount, reservation))
        {
            // Console.Clear();
